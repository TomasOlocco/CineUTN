    ...
    public class PedidoController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Pedido != null ? 
                          ...
                          Problem("Entity set 'CineUTNContext.Pedido'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,IsUrgent,Created")] Pedido pedido)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CineUTNContext.Pedido'  is null.");
            }
            var pedido = await _context.Pedido.FindAsync(id);
            if (pedido != null)
            {
